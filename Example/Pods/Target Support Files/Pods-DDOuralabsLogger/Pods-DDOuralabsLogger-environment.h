...
// DDOuralabsLogger
#define COCOAPODS_POD_AVAILABLE_DDOuralabsLogger
#define COCOAPODS_VERSION_MAJOR_DDOuralabsLogger 0
#define COCOAPODS_VERSION_MINOR_DDOuralabsLogger 1
#define COCOAPODS_VERSION_PATCH_DDOuralabsLogger 0

// Ouralabs
#define COCOAPODS_POD_AVAILABLE_Ouralabs
#define COCOAPODS_VERSION_MAJOR_Ouralabs 2
#define COCOAPODS_VERSION_MINOR_Ouralabs 1
#define COCOAPODS_VERSION_PATCH_Ouralabs 1
